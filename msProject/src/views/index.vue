                ...
                <a-layout style="padding-top: 65px;">
                    ...
                    >
                        <div class="sider-inner">
                                    ...
                                    <template v-for="item in menu">
                                        ...
                                        >
                                            ...
                                            <template v-for="child in item.children">
                                                <!-- 二级菜单：有子菜单 → 继续展开 -->
                                                <a-sub-menu
                                                        v-if="child.children && child.children.length > 0 && !child.is_inner"
                                                ...
                                                >
                                                    ...
                                                    <a-menu-item
                                                            ...
                                                            v-if="!grandChild.is_inner"
                                                            :key="grandChild.id.toString()"
                                                            :disabled="!grandChild.status"
                                                    >
                            ...
                            <!-- 底部用户卡片 -->
                            <div class="sider-user-card" v-if="userInfo">
                                <a-avatar :src="userInfo.avatar" :size="collapsed ? 32 : 36" icon="user" />
                                <div class="user-card-info" v-if="!collapsed">
                                    <div class="user-card-name">{{ userInfo.name || '用户' }}</div>
                                    <div class="user-card-role">{{ currentOrgName }}</div>
                                </div>
                            </div>
                        </div>
                    </a-sider>
