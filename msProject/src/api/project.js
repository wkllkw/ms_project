...
export function batchDelete(projectCodes) {
    return $http.post('project/project/batchDelete', {projectCodes: projectCodes});
}
export function batchRecovery(projectCodes) {
    return $http.post('project/project/batchRecovery', {projectCodes: projectCodes});
}
...
export function saveAsTemplate(data) {
    return $http.post('project/project/saveAsTemplate', data);
}
