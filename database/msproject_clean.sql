...
INSERT INTO `ms_project_menu` (`id`, `pid`, `title`, `icon`, `url`, `file_path`, `params`, `node`, `sort`, `status`, `create_by`, `is_inner`, `values`, `show_slider`) VALUES (1,0,'工作台','home','home','home/index','','home',1,1,0,0,'',1),(10,0,'项目','project','project/list','project/list/index','my','project',2,1,0,0,'',1),(11,10,'项目列表','project','project/list','project/list/index','my','project.list',1,1,0,0,'',1),(12,10,'项目模板','appstore','project/template','project/template/index','','project.template',2,1,0,0,'',1),(20,0,'通知','bell','notify/notice','notify/notice','','notify',2,1,0,0,'',1),(21,20,'通知列表','bell','notify/notice','notify/notice','','notify.notice',1,1,0,0,'',1),(22,20,'系统消息','notification','notify/system','notify/system','','notify.system',2,1,0,0,'',1),(30,0,'团队','team','members','members/index','','members',3,1,0,0,'',1),(31,30,'成员','team','members','members/index','','members.index',1,1,0,0,'',1),(40,0,'系统','setting','system/account','system/account/index','','system',4,1,0,0,'',1),(41,40,'账号管理','user','system/account','system/account/index','','system.account',1,1,0,0,'',1),(42,40,'菜单管理','menu','system/config/menu','system/config/menu','','system.menu',2,1,0,0,'',1),(43,40,'节点管理','apartment','system/config/node','system/config/node','','system.node',3,1,0,0,'',1);
