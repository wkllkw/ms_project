            ...
            <div class="project-nav-header">
                <a-breadcrumb>
                    ...
                    <a-breadcrumb-item>
                        ...
                        <span class="actions" style="margin-left: 12px;">
                            <a-tooltip :mouseEnterDelay="0.3" title="保存为模板" @click="showSaveTemplate">
                                <a-button size="small" icon="save" type="dashed">保存为模板</a-button>
                            </a-tooltip>
                        </span>
                    </a-breadcrumb-item>
                </a-breadcrumb>
...
<script>
    ...
    import {_getProjectReport, _projectStats, doData, read as getProject, saveAsTemplate} from "../../../api/project";
