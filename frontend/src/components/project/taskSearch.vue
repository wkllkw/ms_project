                ...
                <a-form
                    ...
                    >
                        <a-select
                                ...
                                optionFilterProp="children"
                        >
                            <a-select-option :key="tag.code" v-for="tag in taskTagList">
                                <a-badge :class="`badge-${tag.color}`" status="success" style="margin-right: 4px;"/>
                                {{tag.name}}
                            </a-select-option>
                        </a-select>
                    </a-form-item>
...
<script>
    ...
    import {list as getTaskTags} from "../../api/taskTag";
    ...
    export default {
        ...
        methods: {
            ...
            getTaskTagList() {
                getTaskTags({projectCode: this.projectCode}).then(res => {
                    this.taskTagList = res.data || [];
                }).catch(() => {
                    this.taskTagList = [];
                });
            },
