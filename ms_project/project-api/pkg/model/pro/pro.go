...
type ProjectTemplate struct {
	...
	OrganizationCode int64                 `json:"organization_code" gorm:"column:organization_code"`
	Cover            string                `json:"cover"`
	MemberCode       int64                 `json:"member_code" gorm:"column:member_code"`
	IsSystem         int                   `json:"is_system" gorm:"column:is_system"`
	TaskStages       []*TaskStagesOnlyName `json:"task_stages" gorm:"-"`
