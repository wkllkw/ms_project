...
func defaultMenuDefs() []defaultMenuDef {
	return []defaultMenuDef{
		...
		{PreferredID: 14, ParentNode: "project", Title: "归档项目", Icon: "container", Url: "project/archive", FilePath: "project/archive/index", Node: "project.archive", Sort: 4, Status: 1, ShowSlider: 1},
		{PreferredID: 15, ParentNode: "project", Title: "回收站", Icon: "delete", Url: "project/recycle", FilePath: "project/recycle/index", Node: "project.recycle", Sort: 5, Status: 1, ShowSlider: 1},
